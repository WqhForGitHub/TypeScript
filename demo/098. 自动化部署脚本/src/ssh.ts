...
export class SSHClient {
  ...
  constructor(config: { host: string; port: number; username: string }, log: Logger) {
  ...
  /** 上传目录 (模拟) */
  async uploadDirectory(localDir: string, remoteDir: string, totalSize: number): Promise<void> {
    this.assertConnected();
